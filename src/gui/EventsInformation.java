...
public class EventsInformation extends JDialog {
	...
	public static void main(String[] args) {
		try {
			EventsInformation dialog = new EventsInformation();
	...
	public EventsInformation() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(EventsInformation.class.getResource("/imagenes/EventosSolLogo.jpg")));
		setBounds(950, 100, 949, 756);
        ...
        contentPanel = new JPanel(){
			...
			public void paintComponent(Graphics g){
				Image img = Toolkit.getDefaultToolkit().getImage(EventsInformation.class.getResource("/imagenes/EventosBackgroundVentanaInfonew.jpg"));
		...
		btnInscribir.setBounds(720, 478, 118, 29);
		contentPanel.add(btnInscribir);
		
		JButton btnModificar = new JButton("Modificar");
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ModifyEvent c = new ModifyEvent();
				c.setVisible(true);
			}
		});
		btnModificar.setForeground(Color.WHITE);
		btnModificar.setFont(new Font("Tahoma", Font.PLAIN, 16));
		btnModificar.setBackground(new Color(0, 102, 102));
		btnModificar.setBounds(720, 537, 118, 29);
		...
		btnEliminar.setBackground(new Color(0, 102, 102));
		btnEliminar.setBounds(720, 592, 118, 29);
