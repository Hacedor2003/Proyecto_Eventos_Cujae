...
public class MainScreen extends JFrame {
	 ...
	 */
	public MainScreen() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainScreen.class.getResource("/imagenes/EventosSolLogo.jpg")));
		...
		contentPane = new JPanel(){
			...
			public void paintComponent(Graphics g){
				Image img= Toolkit.getDefaultToolkit().getImage(MainScreen.class.getResource("/imagenes/EventosSolBackground.jpg"));
