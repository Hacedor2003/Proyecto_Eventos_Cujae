...
import com.github.weisj.jsvg.attributes.filter.LayoutBounds.Data;
	...
	public Login() {
		...
		txtIngreseSuNombre.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				if (txtIngreseSuNombre.getText().equals(
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < 3 && !search; i++) {
					String[] searchUser = data.getUserProfile(1, i);

					if (searchUser[0].equalsIgnoreCase(user)) {
						if (searchUser[1].equalsIgnoreCase(password)) {
